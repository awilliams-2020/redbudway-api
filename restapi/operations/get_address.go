...
// ContextValidate validates this get address o k body based on context it is used
func (o *GetAddressOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
